...
| 正式地址（上线后） | `https://www.npmjs.com/package/@luma/icons` |
...
Vue 项目请同时安装 [@luma/icons-vue](./icons-vue)。

## 公开入口

| 入口 | 用途 |
| --- | --- |
| `@luma/icons` | 注册、改色、合成、Data URI 等 |
| `@luma/icons/vite` | Vite 静态 SVG 插件 |
...
```ts
import { lumaIconsSvgPlugin } from '@luma/icons/vite'
