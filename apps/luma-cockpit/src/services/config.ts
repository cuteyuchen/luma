  ...
  layouts: [
    {
      ...
      left: {
        ...
        rows: [
          {
            id: 'left-overview-summary', height: 42, mode: 'grid', widgets: [],
            cells: [{ id: 'left-overview-summary-cell', widget: { id: 'w-metric-summary-a', type: 'metric-summary', title: '指标总览' } }],
          },
          {
            id: 'left-overview-tabs', height: 58, mode: 'tabs', cells: [], activeWidgetId: 'w-trend-main',
            widgets: [
      ...
      right: {
        ...
        rows: [
          {
            id: 'right-overview-events', height: 50, mode: 'grid', widgets: [],
            cells: [{ id: 'right-overview-events-cell', widget: { id: 'w-event-list', type: 'event-list', title: '事件列表' } }],
          },
          {
            id: 'right-overview-tabs', height: 50, mode: 'tabs', cells: [], activeWidgetId: 'w-region-ranking',
            widgets: [
    ...
    },
    {
      ...
      left: {
        ...
        rows: [
          {
            id: 'left-analysis-tabs', height: 100, mode: 'tabs', cells: [], activeWidgetId: 'w-trend-analysis',
            widgets: [
      ...
      right: {
        ...
        rows: [
          {
            id: 'right-analysis-tabs', height: 100, mode: 'tabs', cells: [], activeWidgetId: 'w-region-ranking-analysis',
            widgets: [
