...
import type { DataVChartsOption, LumaChartsOption } from '@luma/datav'
...
const echartsOption: LumaChartsOption = {
...
import type { DataVChartsOption } from '@luma/datav'
import { LumaCharts } from '@luma/datav'
...
<template>
  <LumaCharts :config="config" style="height: 260px" />
<\/template>`
...
const propRows: PropRow[] = [
  ...
  { name: 'option', type: 'EChartsOption', default: '{}', description: 'Luma 兼容扩展；仅在未传 config 时启用 ECharts。' },
...
<template>
  ...
  >
    ...
    <DemoBlock
      ...
      :min-height="300"
    >
      <LumaCharts :config="nativeLineConfig" style="height: 260px" />
    </DemoBlock>

    <DemoBlock
      title="ECharts 兼容扩展"
      description="旧项目可继续传 option；这是 Luma 扩展协议，不再标注为 DataV 原生 Charts。"
      :code="echartsCode"
      :min-height="300"
    >
      <LumaCharts :option="echartsOption" theme="dark" style="height: 260px" />
    </DemoBlock>
