...
import type { FlylineEnhancedConfig } from '@lumal/datav'
...
function playCodeGen(model: Record<string, unknown>): string {
  return `<LumalFlylineChartEnhanced
  :config="{
    points: [/* ... */],
    lines: [/* ... */],
...
<template>
  <LumalFlylineChartEnhanced :config="config" style="height: 340px" />
<\/template>`
...
<template>
  ...
  >
    ...
    >
      <LumalFlylineChartEnhanced :config="playConfig" style="height: 340px; width: 100%;" />
    </Playground>
