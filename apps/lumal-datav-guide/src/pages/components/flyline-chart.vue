...
import type { FlylineChartConfig } from '@lumal/datav'
...
<template>
  <LumalFlylineChart :config="config" style="height: 320px" />
<\/template>`
...
<template>
  ...
  >
    ...
    >
      <LumalFlylineChart :config="playConfig" style="height: 320px; width: 100%;" />
    </Playground>
