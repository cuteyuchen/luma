...
.standalone-center__region {
  fill: color-mix(in srgb, var(--lumal-cockpit-accent), transparent 84%);
  stroke: color-mix(in srgb, var(--lumal-cockpit-accent), white 18%);
  stroke-width: 1.2;
...
.standalone-center__region.is-focused {
  fill: color-mix(in srgb, var(--lumal-cockpit-accent), transparent 58%);
  stroke: var(--lumal-cockpit-accent);
  stroke-width: 2;
}

.standalone-center__point {
  fill: var(--lumal-cockpit-warning);
  stroke: var(--lumal-cockpit-title-text);
  stroke-width: 0.8;
}

.standalone-center__point.is-active,
.standalone-center__point.is-focused {
  fill: var(--lumal-cockpit-success);
  stroke-width: 1.4;
}
...
.standalone-center__status {
  ...
  min-height: 44px;
  padding: 8px 12px;
  border: 1px solid var(--lumal-cockpit-border);
