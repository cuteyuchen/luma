...
import { LumalCrudTable, LumalPage } from '@lumal/core/components'
...
const tableConfig = {
  ...
  columnSettings: {
    enabled: true,
    reorderable: true,
    storageKey: 'lumal-example:crud-columns',
  },
}
const toolbarConfig = {
  export: true,
...
<template>
  <main class="lumal-admin-example is-fill">
    <LumalPage title="CRUD Table" :description="message" fill>
      <LumalCrudTable
      ...
      >
        <template #toolbar-actions>
          <button class="lumal-admin-example__button" type="button" @click="editorType = editorType === 'dialog' ? 'drawer' : 'dialog'">
