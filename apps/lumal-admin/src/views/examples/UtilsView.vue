...
<template>
  <main class="lumal-admin-example">
    <LumalPage title="Utils 实验区" description="修改真实输入并执行公开工具函数，错误输入会得到明确反馈。">
      <div class="utils-lab">
        ...
        <LumalInfoTable :items="items" label-width="88px" /><p v-if="error" class="utils-error" role="alert">
          {{ error }}
        </p>
      </div>
    </LumalPage>
