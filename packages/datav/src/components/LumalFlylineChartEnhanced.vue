...
const id = svgId('lumal-flyline-enhanced', useId())
...
<template>
  <div
    ref="rootRef"
    class="lumal-flyline-chart-enhanced"
    role="img"
...
<style scoped>
/* 与 LumalFlylineChart / DataV 一致：SVG 不参与文档流高度计算 */
.lumal-flyline-chart-enhanced {
  position: relative;
  display: block;
  width: 100%;
  height: 100%;
...
.lumal-flyline-chart-enhanced svg {
  position: absolute;
  inset: 0;
  display: block;
  width: 100%;
...
.lumal-flyline-chart-enhanced text {
  text-anchor: middle;
