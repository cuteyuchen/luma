...
const rootStyle = computed<CSSProperties>(() => {
  const style = {
    '--lumal-datav-background': resolvedBackground.value,
    '--lumal-datav-duration': `${durationMs.value}ms`,
    '--lumal-datav-primary': primaryColor.value,
    '--lumal-datav-secondary': secondaryColor.value,
  } as CSSProperties
  ...
  >
    ...
    >
      ...
      <template v-else-if="variant === 3">
        ...
        <polyline class="lumal-border-box__bb3-line1" :stroke="primaryColor" :points="`4, 4 ${width - 22}, 4 ${width - 22}, ${height - 22} 4, ${height - 22} 4, 4`" />
        <polyline class="lumal-border-box__bb3-line2" :stroke="secondaryColor" :points="`10, 10 ${width - 16}, 10 ${width - 16}, ${height - 16} 10, ${height - 16} 10, 10`" />
        <polyline class="lumal-border-box__bb3-line2" :stroke="secondaryColor" :points="`16, 16 ${width - 10}, 16 ${width - 10}, ${height - 10} 16, ${height - 10} 16, 16`" />
        <polyline class="lumal-border-box__bb3-line2" :stroke="secondaryColor" :points="`22, 22 ${width - 4}, 22 ${width - 4}, ${height - 4} 22, ${height - 4} 22, 22`" />
      </template>
      ...
      <template v-else-if="variant === 4">
        ...
        />
        <polyline class="lumal-border-box__bb4-line1" :stroke="primaryColor" :points="`145, ${height - 5} 40, ${height - 5} 10, ${height - 35} 10, 40 40, 5 150, 5 170, 20 ${width - 15}, 20`" />
        <polyline class="lumal-border-box__bb4-line2" :stroke="secondaryColor" :points="`245, ${height - 1} 36, ${height - 1} 14, ${height - 23} 14, ${height - 100}`" />
        <polyline class="lumal-border-box__bb4-line3" :stroke="primaryColor" :points="`7, ${height - 40} 7, ${height - 75}`" />
        <polyline class="lumal-border-box__bb4-line4" :stroke="primaryColor" points="28, 24 13, 41 13, 64" />
        <polyline class="lumal-border-box__bb4-line5" :stroke="primaryColor" points="5, 45 5, 140" />
        <polyline class="lumal-border-box__bb4-line6" :stroke="secondaryColor" points="14, 75 14, 180" />
        <polyline class="lumal-border-box__bb4-line7" :stroke="secondaryColor" points="55, 11 147, 11 167, 26 250, 26" />
        <polyline class="lumal-border-box__bb4-line8" :stroke="secondaryColor" points="158, 5 173, 16" />
        <polyline class="lumal-border-box__bb4-line9" :stroke="primaryColor" :points="`200, 17 ${width - 10}, 17`" />
        <polyline class="lumal-border-box__bb4-line10" :stroke="secondaryColor" :points="`385, 17 ${width - 10}, 17`" />
      </template>
      ...
      <template v-else-if="variant === 5">
        ...
        <polyline class="lumal-border-box__bb5-line1" :stroke="primaryColor" :points="`8, 5 ${width - 5}, 5 ${width - 5}, ${height - 100} ${width - 100}, ${height - 5} 8, ${height - 5} 8, 5`" />
        <polyline class="lumal-border-box__bb5-line2" :stroke="secondaryColor" :points="`3, 5 ${width - 20}, 5 ${width - 20}, ${height - 60} ${width - 74}, ${height - 5} 3, ${height - 5} 3, 5`" />
        <polyline class="lumal-border-box__bb5-line3" :stroke="secondaryColor" :points="`50, 13 ${width - 35}, 13`" />
        <polyline class="lumal-border-box__bb5-line4" :stroke="secondaryColor" :points="`15, 20 ${width - 35}, 20`" />
        <polyline class="lumal-border-box__bb5-line5" :stroke="secondaryColor" :points="`15, ${height - 20} ${width - 110}, ${height - 20}`" />
        <polyline class="lumal-border-box__bb5-line6" :stroke="secondaryColor" :points="`15, ${height - 13} ${width - 110}, ${height - 13}`" />
      </template>
      ...
      <template v-else-if="variant === 7">
        <polyline class="lumal-border-box__bb7-line2" :stroke="primaryColor" points="0, 25 0, 0 25, 0" />
        <polyline class="lumal-border-box__bb7-line2" :stroke="primaryColor" :points="`${width - 25}, 0 ${width}, 0 ${width}, 25`" />
        <polyline class="lumal-border-box__bb7-line2" :stroke="primaryColor" :points="`${width - 25}, ${height} ${width}, ${height} ${width}, ${height - 25}`" />
        <polyline class="lumal-border-box__bb7-line2" :stroke="primaryColor" :points="`0, ${height - 25} 0, ${height} 25, ${height}`" />
        <polyline class="lumal-border-box__bb7-line5" :stroke="secondaryColor" points="0, 10 0, 0 10, 0" />
        <polyline class="lumal-border-box__bb7-line5" :stroke="secondaryColor" :points="`${width - 10}, 0 ${width}, 0 ${width}, 10`" />
        <polyline class="lumal-border-box__bb7-line5" :stroke="secondaryColor" :points="`${width - 10}, ${height} ${width}, ${height} ${width}, ${height - 10}`" />
        <polyline class="lumal-border-box__bb7-line5" :stroke="secondaryColor" :points="`0, ${height - 10} 0, ${height} 10, ${height}`" />
      </template>
    ...
    <template v-if="variant === 1">
      <svg
        ...
        :key="corner"
        aria-hidden="true"
        class="lumal-border-box__bb1-corner"
        :class="`lumal-border-box__bb1-corner--${corner}`"
        focusable="false"
        width="150px"
        height="150px"
      >
    ...
    <div class="lumal-border-box__content">
      <slot />
    </div>
  </div>
</template>
