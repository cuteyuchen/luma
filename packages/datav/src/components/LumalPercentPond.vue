...
const borderGradientId = `lumal-percent-pond-border-${instanceId}`
const progressGradientId = `lumal-percent-pond-progress-${instanceId}`
...
<template>
  ...
  >
    ...
    >
      ...
      <rect
        class="lumal-percent-pond__border"
        :x="safeBorderWidth / 2"
        :y="safeBorderWidth / 2"
        :rx="borderRadius"
        :ry="borderRadius"
      ...
      />
      <polyline
        class="lumal-percent-pond__progress"
        fill="none"
      ...
      <text
        v-if="showLabel"
        class="lumal-percent-pond__label"
        :stroke="textColor"
        :fill="textColor"
        :x="width / 2"
        :y="height / 2"
