...
<template>
  <section class="lumal-cockpit-card" :class="{ 'is-tabs': hasTabs }">
    <header v-if="hasTabs" class="lumal-cockpit-card__header">
      <div class="lumal-cockpit-card__tablist" role="tablist" aria-label="模块切换">
        <button
    ...
    <header v-else-if="displayTitle || $slots.title" class="lumal-cockpit-card__header">
      <div class="lumal-cockpit-card__title">
    ...
    <div
      ...
      class="lumal-cockpit-card__body"
