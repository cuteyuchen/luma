...
- `apps/playground`：组件开发预览应用，通过公开包入口消费 `@luma/*`。
- `apps/luma-admin`：Luma 原生写法示例应用，验证 layout、router、permission、CRUD 和 request 的组合方式。
...
@luma/icons
     ↑
@luma/core  ←  apps/playground / apps/luma-admin
     ↑
